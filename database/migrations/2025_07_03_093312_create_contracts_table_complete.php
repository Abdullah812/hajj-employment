...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('contracts', function (Blueprint $table) {
            ...
            // معلومات القسم في العقد
            $table->string('department_name');
            $table->string('department_address');
            $table->string('department_commercial_register');
            $table->string('department_email');
            $table->string('department_representative_name');
            $table->string('department_representative_title');
            
            // معلومات العقد
            $table->text('contract_terms')->nullable();
            $table->date('contract_date');
            $table->string('hijri_date')->nullable();
            $table->string('hijri_contract_start_date')->nullable();
            $table->string('hijri_contract_end_date')->nullable();
            $table->string('contract_location')->nullable();
            $table->string('contract_city')->nullable();
            $table->string('contract_country')->default('المملكة العربية السعودية');
            ...
            $table->string('department_signature')->nullable();
