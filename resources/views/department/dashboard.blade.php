...
@section('title', 'لوحة تحكم القسم - شركة مناسك المشاعر')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('department.jobs.index') }}" class="btn btn-outline-primary btn-sm">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('department.applications.index') }}" class="btn btn-outline-warning btn-sm">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('department.applications.index') }}" class="btn btn-outline-warning">
                            <i class="fas fa-list me-2"></i>مراجعة الطلبات
                        </a>
                        <a href="{{ route('department.jobs.index') }}" class="btn btn-outline-primary">
