...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('department.dashboard') }}" class="btn btn-outline-secondary">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('department.applications.index') }}">
                <div class="row g-3">
                    <div class="col-md-3">
                ...
                @if(request()->hasAny(['search', 'job_id', 'status', 'sort']))
                    <div class="mt-3">
                        <a href="{{ route('department.applications.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="card-body p-0">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3">
                            <div class="d-flex justify-content-end gap-1 flex-wrap">
                                ...
                                @if($application->status == 'pending')
                                    <!-- قبول -->
                                    <form method="POST" action="{{ route('department.applications.update', $application) }}" class="d-inline">
                                        @csrf
                                        @method('PUT')
                ...
                @if($application->status == 'pending')
                    <div class="modal fade" id="rejectModal{{ $application->id }}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{ route('department.applications.update', $application) }}">
                                    @csrf
                                    @method('PUT')
            ...
            @empty
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('department.jobs.index') }}" class="btn btn-primary">
...
function bulkAction(status) {
    ...
    if (confirm(`هل أنت متأكد من ${action} ${ids.length} طلب؟`)) {
        ...
        fetch('{{ route("department.applications.bulk") }}', {
            method: 'POST',
            body: formData
        })
        .then(response => {
