...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('department.jobs.index') }}" class="btn btn-outline-secondary">
    ...
    <form method="POST" action="{{ route('department.jobs.store') }}">
        @csrf
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('department.jobs.index') }}" class="btn btn-outline-danger">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        document.querySelector('.preview-department').innerHTML = '<i class="fas fa-tags me-1"></i>{{ auth()->user()->name }}';
    ...
    // ربط الأحداث
    ['title', 'location', 'salary_min', 'salary_max', 'application_deadline'].forEach(function(field) {
