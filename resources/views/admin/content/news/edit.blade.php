            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 text-secondary mb-1">
                        <i class="fas fa-edit me-2"></i>تعديل الخبر
                    </h2>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('category') is-invalid @enderror" id="category" name="category">
                                ...
                                <option value="أخبار الشركة" {{ old('category', $news->category) === 'أخبار الشركة' ? 'selected' : '' }}>أخبار الشركة</option>
                                <option value="الحج والعمرة" {{ old('category', $news->category) === 'الحج والعمرة' ? 'selected' : '' }}>الحج والعمرة</option>
                                <option value="التوظيف" {{ old('category', $news->category) === 'التوظيف' ? 'selected' : '' }}>التوظيف</option>
                                <option value="الإنجازات" {{ old('category', $news->category) === 'الإنجازات' ? 'selected' : '' }}>الإنجازات</option>
                                <option value="التطوير" {{ old('category', $news->category) === 'التطوير' ? 'selected' : '' }}>التطوير</option>
                                <option value="عام" {{ old('category', $news->category) === 'عام' ? 'selected' : '' }}>عام</option>
                            </select>
                            @error('category')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('published_at') is-invalid @enderror" 
                                   id="published_at" name="published_at" value="{{ old('published_at', $news->published_at ? $news->published_at->format('Y-m-d\TH:i') : '') }}">
