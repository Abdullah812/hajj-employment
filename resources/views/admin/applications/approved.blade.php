                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                                ...
                                <div class="info-content">
                                    <div class="attachments-grid">
                                        @if($user->profile->cv_file_data)
                                            ...
                                            @endif
                                        @endif
                                                                @if($user->profile->national_id_file_data)
                            @if($user->profile->national_id_attachment_url)
                                            ...
                                            @endif
                                        @endif
                                                                @if($user->profile->iban_file_data)
                            @if($user->profile->iban_attachment_url)
                                            ...
                                            @endif
                                        @endif
                                                                @if($user->profile->experience_file_data)
                            @if($user->profile->experience_certificate_url)
                                            ...
                                            @endif
                                        @endif
                                                                @if($user->profile->national_address_file_data)
