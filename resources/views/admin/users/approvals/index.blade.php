    ...
    return `
        ...
        <div class="user-details-section">
            ...
            <div class="attachment-links">
                ${profile.cv_path ? `<a href="${profile.cv_url}" class="btn btn-info btn-sm" target="_blank"><i class="fas fa-file-pdf me-1"></i>السيرة الذاتية</a>` : ''}
                ${profile.national_id_attachment ? `<a href="${profile.national_id_attachment_url}" class="btn btn-success btn-sm" target="_blank"><i class="fas fa-id-card me-1"></i>الهوية الوطنية</a>` : ''}
                ${profile.iban_attachment ? `<a href="${profile.iban_attachment_url}" class="btn btn-primary btn-sm" target="_blank"><i class="fas fa-university me-1"></i>مرفق الآيبان</a>` : ''}
                ${profile.national_address_attachment ? `<a href="${profile.national_address_attachment_url}" class="btn btn-warning btn-sm" target="_blank"><i class="fas fa-home me-1"></i>العنوان الوطني</a>` : ''}
                ${profile.experience_certificate ? `<a href="${profile.experience_certificate_url}" class="btn btn-secondary btn-sm" target="_blank"><i class="fas fa-certificate me-1"></i>شهادة الخبرة</a>` : ''}
            </div>
            ${!profile.cv_path && !profile.national_id_attachment && !profile.iban_attachment && !profile.national_address_attachment && !profile.experience_certificate ? 
